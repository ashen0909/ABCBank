...
public class AuthenticationController {
    ...
    public ResponseEntity<?> createAuthenticationToken(@RequestBody AuthenticationRequest authenticationRequest)
        ...
        UserDto correspondingUserDto = new UserDto(correspondingUser.getId(),correspondingUser.getFirstname(), correspondingUser.getLastname(),correspondingUser.getEmail(),correspondingUser.getPhone(),correspondingUser.getNic(),correspondingUser.getAddress(),correspondingUser.getCity(),correspondingUser.getCountry(), correspondingUser.getRoles());
